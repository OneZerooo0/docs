# Minor Faction Guidelines

## What is this?

This section contains information regarding the creation of minor faction content.

## Minor Factions: What Are They?
...
- Faction design should also be original and fit with Monolith's environment thematically. (e.g no Galactic Empire from *Star Wars*, and no pirates sailing space in wooden boats using stereotypical cannons.)
...
- Minor faction gear should adhere to [ground combat guidelines.](en/monolith/combat/groundcombat.md)
    - Gear should not be overpowered and equipment should stick to the faction's theming.
- Additionally, minor faction gear should **be unique**, even at earlier levels of research - A faction can have a retextured existing weapon if it fits thematically, but should prioritize gimmicks and uniqueness.

#### Lore
- Lore is difficult. Minor factions should have some level of reasoning for their existence, though most of what determines approval is in thematics.
    - Lore is secondary to content - If you make cool content for a faction its okay if the lore isn't complete.
